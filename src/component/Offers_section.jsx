          ...
          <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <div className="rounded-3xl p-8 ring-1 xl:p-10 ring-yellow-400">
              ...
              <p className="mt-6 flex items-baseline gap-x-1">
                ...
                <span className="text-sm font-semibold leading-6 text-purple-600">/Week</span>
              </p>
            ...
            <div className="rounded-3xl p-8 ring-1 xl:p-10 ring-gray-700">
              <h3 id="tier-startup" className="text-lg font-semibold leading-8 text-gray-900">Offer's Name</h3>
              <p className="mt-4 text-sm leading-6 text-cyan-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, ex?</p>
              <p className="mt-6 flex items-baseline gap-x-1">

                <span className="text-4xl font-bold tracking-tight text-yellow-700">$900</span>
            ...
            <div className="rounded-3xl p-8 ring-1 xl:p-10 bg-blue-600 ring-blue-400">
              <h3 id="tier-enterprise" className="text-lg font-semibold leading-8 text-white">Offer's Name</h3>
              <p className="mt-4 text-sm leading-6 text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, ex?</p>
              <p className="mt-6 flex items-baseline gap-x-1">
