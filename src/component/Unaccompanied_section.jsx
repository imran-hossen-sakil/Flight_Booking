...
<div class="">
    <h2 class="italic md:not-italic text-3xl">Unaccompanied <br /><span className="italic md:not-italic"> Minors Lounge.</span></h2>
...
<div class="grid md:grid-cols-2 gap-10 mt-10">
    ...
    <div class="flex gap-4 items-start">
        ...
        <div>
            <h3 class="font-semibold text-xl">Help through the airport</h3>
            <p class="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates reprehenderit consequuntur</p>
        </div>
    </div>
    ...
    <div class="flex gap-4 items-start">
        ...
        <div>
            <h3 class="font-semibold text-xl">Priority boarding</h3>
            <p class="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates reprehenderit consequuntur consequatur hic ipsam? Id? </p>
        </div>
    </div>
    ...
    <div class="flex gap-4 items-start">
        ...
        <div>
            <h3 class="font-semibold text-xl">Care on the flight</h3>
            <p class="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates reprehenderit consequuntur consequatur hic ipsam? Id?</p>
        </div>
    </div>
    ...
    <div class="flex gap-4 items-start">
        ...
        <div>
            <h3 class="font-semibold text-xl">Support When the Load</h3>
            <p class="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates consequuntur? </p>
        </div>
    </div>
