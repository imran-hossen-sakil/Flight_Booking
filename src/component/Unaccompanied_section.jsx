...
function Unaccompanied_section() {
  return (
    <div>
...
<div className="sm:flex items-center max-w-screen-xl mx-auto">
    <div className="sm:w-1/2 p-10">
        <div className="image object-center text-center">
            <img className='mt-24' src="https://d.newsweek.com/en/full/2303784/pilot-near-plane-aircraft-sky.jpg"/>
        </div>
    </div>
...
<div className="">
    <h2 className="italic md:not-italic text-3xl">Unaccompanied <br /><span className="italic md:not-italic"> Minors Lounge.</span></h2>
...
<div className="grid md:grid-cols-2 gap-10 mt-10">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl">Help through the airport</h3>
            <p className="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates reprehenderit consequuntur</p>
        </div>
    </div>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl">Priority boarding</h3>
            <p className="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates reprehenderit consequuntur consequatur hic ipsam? Id? </p>
        </div>
    </div>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl">Care on the flight</h3>
            <p className="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates reprehenderit consequuntur consequatur hic ipsam? Id?</p>
        </div>
    </div>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl">Support When the Load</h3>
            <p className="mt-1 text-gray-500"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ratione tempore nemo fugiat voluptates consequuntur? </p>
        </div>
    </div>
...
export default Unaccompanied_section
