...
function Best_travel_section() {
  return (
    <div>
        <div class="relative flex w-60 h-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          <div class="relative mx-4 mt-4 h-20 w-50 overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
          ...
          <div class="p-6 text-center">
            <h4 class="mb-2 block font-sans font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
              imran
            </h4>
            <p class="block bg-gradient-to-tr from-pink-600 to-pink-400 bg-clip-text font-sans text-base leading-relaxed text-transparent antialiased">
              imran
            </p>
          </div>
